...
import {KeysOf, RxEvents, ValuesOf} from './types';
import {ErrorHandler} from '@angular/core';

export function eventProxyHandler<T extends object, U extends object>(
  subjects: { [K in keyof T]: Subject<ValuesOf<T>> },
  transforms?: U,
  errorHandler?: ErrorHandler
): ProxyHandler<RxEvents<T, U>> {
  ...
  return {
    ...
    apply(_: RxEvents<T, U>, __: any, props: [T]): any {
      props.forEach((slice) =>
